          ...
          return (
            <div
              ...
              style={{
                ...
                height: "100%",
                background:
                  "linear-gradient(to top, rgb(255, 120, 60), transparent)",
...
export const Component: React.FC = () => {
  ...
  return (
    <section className="relative w-full min-h-screen flex flex-col items-center px-6 sm:px-8 md:px-12 overflow-hidden">
      ...
      <div className="relative z-10 mt-20 text-center w-full max-w-4xl mx-auto flex flex-col items-center justify-center min-h-screen py-8 sm:py-16">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 md:gap-6 max-w-5xl mx-auto">
          {features.map((feature, idx) => (
            <div
              key={idx}
              className="backdrop-blur-xl bg-white/5 border border-white/10 rounded-xl p-4 md:p-6 h-40 md:h-48 flex flex-col justify-start items-start space-y-2 md:space-y-3"
            >
