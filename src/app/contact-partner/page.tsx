import { ContactPartnerSection } from "@/components/pages/ContactPartnerSection";
import MainLayout from "@/layouts/MainLayout";
import { Metadata } from "next";

export const metadata: Metadata = {
  metadataBase: new URL("https://pionechain.com/"),
  title: "Contact Partner | Pione Chain | Real-World Assets (RWA) Tokenization",
  description:
...
export default async function ContactPartner() {
  return (
    <MainLayout>
